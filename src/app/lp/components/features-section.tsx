...
export function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      title: '通知・リマインド',
      description:
        '記録を忘れないように、リマインド通知を設定できます。定時リマインドに加え、まだ記録がない場合は追加で通知が届く「追いリマインド」機能も。',
      highlights: ['最大5つの時刻を設定可能', '追いリマインドで記録忘れを防止', '全デバイスに同時配信'],
    },
    {
      icon: Smartphone,
      title: 'マルチデバイス対応',
    ...
    },
    {
      ...
      title: 'みんなで応援',
      description:
        '仲間の頑張りを「お祝い」で応援できます。達成や共有投稿がフィードに流れ、お祝いボタンでパーティクルエフェクトが表示されます。ADHDの報酬系を余分に刺激しない設計です。',
      highlights: [
